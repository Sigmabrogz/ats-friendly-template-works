...
const CreativeTech = ({ data }: { data: ResumeData }) => {
  return (
    <div className="max-w-[21cm] mx-auto bg-white p-8 shadow-lg animate-template-fade relative overflow-hidden">
      ...
      <div className="relative z-10">
        <header className="bg-white/80 backdrop-blur-lg border border-white/20 rounded-xl p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            <section className="bg-white/80 backdrop-blur-lg rounded-xl p-6 border border-white/20">
